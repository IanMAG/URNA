...
class UE:
    ...
    def mensagem(self):
        self.msg = Label(self.main, font = "calibri 14 italic bold", fg = "ORANGE", text = "Aperte no LARANJA para apagar o voto")
        self.msg.place(relx = 0.2, rely = 0.4)
        self.msgSec = Label(self.main, font = "calibri 14 italic bold", fg = "GREEN", text = "Aperte no VERDE para apagar o voto")
        self.msgSec.place(relx = 0.5, rely = 0.4)
